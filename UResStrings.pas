...
ResourceString
 ...
 SAS_MSG_SelectArea='Часть выделенной области находится вне карты.'+#13#10+'Область будет ограничена по размерам карты.';
 SAS_MSG_FileExists='уже есть у вас в кеше.'+#13#10+'Заменить этот файл вновь скачанным?';
 ...
 SAS_MSG_GarminMax1Mp='Количество полученных jpeg-файлов превысит 100 штук, если ваш'+#13#10+'навигатор не отображает карту разбейте сохраняемое изображение на части в '+#13#10+'диалоге "Операции с выделенной областью\склеить"'+#13#10+'и используйте полученные kmz по отдельности';
 ...
 SAS_STR_CreateArhList='(Создание списка для архивации...)';
 SAS_STR_Pack='Упаковка в файл';
 SAS_STR_CreateFile='Подождите, идет создание файла...';
 SAS_STR_DivideInto='Разбить на';
 SAS_STR_Resolution='Разрешение';
 SAS_STR_SaveFileNum='Сохранение файла №';
