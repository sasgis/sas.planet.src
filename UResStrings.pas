...
ResourceString
 ...
 SAS_MSG_GarminMax1Mp='Учтите, что разрешение файлов в kmz для Garmin должно быть меньше 1Mpix,'+#13#10+'разбейте сохраняемое изображение на части в диалоге "Операции с выделенной областью\склеить"';
