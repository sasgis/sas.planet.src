...
ResourceString
 ...
 SAS_MSG_GarminMax1Mp='Учтите, что разрешение файлов в kmz для Garmin в теории'+#13#10+'должно быть меньше 1Mpix, если ваш навигатор не отображает карту разбейте'+#13#10+'сохраняемое изображение на части в диалоге "Операции с выделенной областью\склеить"';
