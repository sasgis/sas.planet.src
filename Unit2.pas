...
begin
 ...
 begin
  ...
  LL1:=Point(mWd2-(FMain.ScreenCenterPos.x-LL1.x),mHd2-(FMain.ScreenCenterPos.y-LL1.y));
  ...
  LL2:=Point(mWd2-(FMain.ScreenCenterPos.x-LL2.x),mHd2-(FMain.ScreenCenterPos.y-LL2.y));
  ...
  begin
    ...
    for i:=0 to length(arLL)-1 do begin
      ...
      arLL[i]:=Point(mWd2-(FMain.ScreenCenterPos.x-arLL[i].x),mHd2-(FMain.ScreenCenterPos.y-arLL[i].y));
      poly[i]:=arrLL^[i];
    end;
