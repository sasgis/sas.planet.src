...
type
  TMiniMapLayerMinusButton = class(TWindowLayerAbstract)
  private
...
procedure TMiniMapLayerMinusButton.OnPaintLayer(Sender: TObject;
  Buffer: TBitmap32);
var
...
procedure TMiniMapLayerMinusButton.UpdateLayerLocation(
  const AViewSize: TPoint;
  const AMiniMapWidth: Integer;
  const ABottomMargin: Integer
);
var
  VLocation: TRect;
begin
  VLocation.Left := AViewSize.X - AMiniMapWidth + 19;
