...
type
  ILocalCoordConverter = interface
    ...
    function LocalPixel2MapPixel(const APoint: TPoint; ARounding: TPointRounding): TPoint;
    ...
    function MapPixel2LocalPixel(const APoint: TPoint; ARounding: TPointRounding): TPoint;
